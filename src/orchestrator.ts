...
import { runStep6Score } from './steps/step6-score';
...
function pipelineSequence(_job: JobRecord): StepName[] {
  // Single pipeline: all six steps run in order. Step 6 (score) skips itself
  // when mode != provision.
  return ['evalgen', 'enhance', 'schema', 'connector', 'deploy', 'score'];
}
